...
public class Xx5HistorySumSingleDoubleTest extends AbstractStatisticsTest {

	@Autowired
	@Qualifier("xx5HistorySumSingleDoubleStatistics")
	private StatisticsComponent statistics;

	private String distributionKey = Xx5ChartType.HistorySumSingleDouble.getKey();
	// 期望結果
