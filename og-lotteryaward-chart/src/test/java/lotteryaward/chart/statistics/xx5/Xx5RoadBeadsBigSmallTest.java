...
public class Xx5RoadBeadsBigSmallTest extends AbstractStatisticsTest{

	
	@Autowired
	@Qualifier("xx5RoadBeadsBigSmallStatistics")
	private StatisticsComponent xx5RoadBeadsBigSmallStatistics;
	...
	public void testStaistics() {
		Map<String,Object> map = xx5RoadBeadsBigSmallStatistics.chartRecord(vo);
