...
public class Xx5SingleDoubleDistributionTest extends AbstractStatisticsTest {

	@Autowired
	@Qualifier("xx5SingleDoubleBalanceDistributionStatistics")
	private StatisticsComponent statistics;

	ChartStaisticsVo vo = new ChartStaisticsVo();

	String distributionKey = Xx5ChartType.SingleDoubleDistribution.getKey();
	
	//期望結果
	List<Integer[]> expectDistribution = Arrays.asList(
			new Integer[][]{{1,-1},{-1,1},{1,-9},{-1,1},{1,-9}});	
