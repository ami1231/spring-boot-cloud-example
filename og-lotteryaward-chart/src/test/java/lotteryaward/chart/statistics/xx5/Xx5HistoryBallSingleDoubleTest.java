...
public class Xx5HistoryBallSingleDoubleTest extends AbstractStatisticsTest {

	@Autowired
	@Qualifier("xx5HistoryBallSingleDoubleStatistics")
	private StatisticsComponent statistics;

	private String distributionKey = Xx5ChartType.HistoryBallSingleDouble.getKey();
	// 期望結果
	...
	List<int[]> distribution = Arrays.asList(new int[][] {
		{23,26,11},{23,30,11},{24,28,8},{25,24,10},{23,27,6}});
